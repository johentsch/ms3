...
# module_dir = os.path.join(__location__, "../src/ms3")
# try:
...
try:
    from ms3 import __version__ as version
except ImportError:
    pass
else:
    release = version
...
intersphinx_mapping = {
    ...
    'python': ('https://docs.python.org/stable' + python_version, None),
    'matplotlib': ('https://matplotlib.org', None),
    'numpy': ('https://docs.scipy.org/doc/numpy/stable', None),
